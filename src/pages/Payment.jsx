...
const Payment = () => {
  ...
  // ---------- Meta Pixel Purchase tracking helper ----------
  const trackPurchaseEvent = (amount, product, paymentMethod) => {
    if (typeof window.fbq === "function") {
      ...
      console.log("Meta Pixel Purchase tracked:", { amount, paymentMethod });
    } else {
      console.warn("Meta Pixel not loaded – purchase event not tracked");
    }
  };
  ...
  const handlePayment = () => {
    ...
    // Fire Meta Pixel purchase event before redirect
    trackPurchaseEvent(amount, product, selectedMethod);

    // Small delay to ensure the tracking beacon is sent
    setTimeout(() => {
      ...
      if (redirect_url) {
        ...
        // No redirect – reset processing state
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <div className="bg-white md:mb-15">
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      <div className="flex gap-2 font-bold text-[15px] items-center text-gray-800">
                        <span>₹{getPriceForMethod("phonepe")}</span>
              ...
              {settings.show_gpay == 1 && (
                ...
                >
                  <div className="flex items-center">
                    ...
                    <div>
                      <div className="flex gap-2 font-bold text-[15px] items-center text-gray-800">
                        <span>₹{getPriceForMethod("gpay")}</span>
                        <span className="text-gray-400 font-light">|</span>
                        <span>GPay</span>
                      </div>
              ...
              {settings.show_paytm == 1 && (
                ...
                >
                  <div className="flex items-center">
                    ...
                    <div>
                      <div className="flex gap-2 font-bold text-[15px] items-center text-gray-800">
                        <span>₹{getPriceForMethod("paytm")}</span>
                        <span className="text-gray-400 font-light">|</span>
                        <span>PayTM</span>
                      </div>
        ...
        <div className="bg-[#E7F9ED] rounded-lg p-4 mb-4 text-center m-4 font-medium">
          ...
          <div className="text-[14px] text-justify leading-snug -mt-3 w-full max-w-md">
            ...
            cashback! Cashback will be credited to your original UPI payment method after delivery.
          </div>
        </div>
      ...
      <div className="fixed bottom-0 left-0 w-full bg-white shadow-[0_-1px_5px_rgba(0,0,0,0.1)] p-4 px-6 flex md:hidden z-50 justify-between items-center border-t border-gray-100">
        ...
        <button
          className="bg-[#FFC107] text-black font-bold py-3 px-8 rounded-lg shadow-sm uppercase text-[15px] cursor-pointer border-none disabled:opacity-50"
      ...
      <div className="hidden md:flex fixed bottom-0 w-full bg-white shadow-[0_-2px_10px_rgba(0,0,0,0.1)] p-3 z-50 justify-between items-center mx-auto left-0 right-0">
        ...
        <button
          className="w-[50%] bg-[#FFC107] text-black font-semibold py-3 border-none rounded-sm shadow-sm uppercase text-[14px] cursor-pointer disabled:opacity-50"
          onClick={handlePayment}
          disabled={isProcessing}
        >
          {isProcessing ? "PROCESSING..." : "PROCEED TO PAY"}
